                ...
                default: {
                    ...
                    switch (message.type) {
                        ...
                        case "FastConfig_Change": {
                            const FastConfig_Path = require(process.cwd() + "/Razafca.json");
                            ...
                            const SetConfig = function(Name, Value, Path, Main_Path) {
                                try {
                                    ...
                                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/Razafca.json", JSON.stringify(FastConfig_Path, null, "\t"));
                                    ...
                                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/Razafca.json", JSON.stringify(FastConfig_Global, null, "\t"));
