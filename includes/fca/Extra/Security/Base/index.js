...
if (!fs.existsSync(process.cwd() + '/Raza_DataBase') || !fs.existsSync(process.cwd() + '/Raza_DataBase/RandPass.json')) {
  ...
  fs.writeFileSync(process.cwd() + '/Raza_DataBase/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/Raza_DataBase/RandPass.json'));
}
