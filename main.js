...
try {
    ...
    if (!existsSync(appStateFile)) {
        logger.loader("Appstate not found. Please provide it via the web dashboard.", "warn");
    ...
    logger.loader("Appstate error: " + e.message, "error");
    global.client.appStateMissing = true;
}
...
function onBot({ models: botModel }) {
    ...
    if (global.client.appStateMissing) {
        logger.loader("AppState is missing. Please upload appstate via web dashboard.", "warn");
        return;
    }
