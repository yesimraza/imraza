...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "𝐊𝐀𝐒𝐇𝐈𝐅 𝐑𝐀𝐙𝐀",
  description: "Create information card of your group box",
...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  for (let z in threadInfo.userInfo) {
    ...
    else nope.push(threadInfo.userInfo[z].name);
  }
  ...
  ctx.fillText(`• Together with ${parseInt(threadMem)-3} other members...`, 607, 453);
